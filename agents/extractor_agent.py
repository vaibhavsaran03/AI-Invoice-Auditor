...
def extract_invoice_data(file_path: str) -> str:
    ...
    """
    print(f"Extractor Agent: Reading {file_path}...")
    ...
    try:
        ...
        # If it's an Image (PNG)
            ...
            try:
                print("Oh, an image! Using OCR to read it...")
                image = Image.open(file_path)
                extracted_text = pytesseract.image_to_string(image)
            except Exception as ocr_error:
                print(f"OCR Error: Tesseract engine not found on server. {ocr_error}")
        ...
        print("Extractor Agent: Done reading! Here is a sneak peek of what I found:")
